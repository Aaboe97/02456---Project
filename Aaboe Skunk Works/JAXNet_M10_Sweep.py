#%%########### JAXNet_M10_Sweep: MNIST Hyperparameter Sweep ##############
"""
MNIST hyperparameter sweep script for WandB using JAX.
...
from JAXNet import JAXNetBase, train, evaluate_model, plot_training_results, plot_confusion_matrix
