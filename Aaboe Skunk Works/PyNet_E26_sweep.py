#%%########### PyNet_E26_Sweep: EMNIST Letters Hyperparameter Sweep ##############
"""
EMNIST Letters hyperparameter sweep script for WandB.
...
def train_sweep():
    ...
    print("=" * 70)
    print(f"Starting EMNIST Letters sweep run: {run.name}")
    print("=" * 70)
